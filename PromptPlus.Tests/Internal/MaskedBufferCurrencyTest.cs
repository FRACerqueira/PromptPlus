...
{
    public class MaskedBufferCurrencyTest
    {
        ...
        {
            // Given
            var maskedBuffer = new MaskedBuffer(new OptionsForMaskeditCurrency(new CultureInfo("en-US"),10,2, MaskedSignal.Enabled, null));
