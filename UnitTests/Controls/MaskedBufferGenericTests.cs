...
namespace PPlus.Tests.Controls
{
    ...
    public  class MaskedBufferGenericTests : BaseTest
    {
        ...
        {
            // Given
            _maskedBuffer.Load(_maskedBuffer.RemoveMask(@"XYZ 222-AAA-AX-QQQ",false));
            //then
        ...
        {
            // Given
            _maskedBuffer.Load(_maskedBuffer.RemoveMask("XYZ AAA-AAA-AX-QQQ", false));
            //then
        ...
        {
            // Given
            _maskedBuffer.Load(_maskedBuffer.RemoveMask("XYZ 222-AAA", true));
            //then
