...
#pragma warning restore IDE0130 // Namespace does not match folder structure
{
    ...
    public interface IMultiTableControl<T>
    {
        ...
        /// </summary>
        /// <param name="styleType">The <see cref="MultiTableStyles"/> element whose style is overridden.</param>
...
#pragma warning restore CA1716 // Identifiers should not match keywords
        ...
        /// <returns>The current <see cref="IMultiTableControl{T}"/> instance for chaining.</returns>
        IMultiTableControl<T> Interaction<T1>(IEnumerable<T1> items,
            Action<T1, IMultiTableControl<T>> interactionAction);
        ...
        /// <returns>The current <see cref="IMultiTableControl{T}"/> instance for chaining.</returns>
        IMultiTableControl<T> InteractionAsync<T1>(IEnumerable<T1> items,
            Func<T1, IMultiTableControl<T>, Task> interactionAction);
    }
}
