...
#pragma warning restore IDE0130 // Namespace does not match folder structure
{
    ...
    /// Every configuration method returns the same <see cref="ITableSelectControl{T}"/> instance so
    ...
    public interface ITableSelectControl<T>
    {
        ...
        /// <returns>
        /// A <see cref="ResultPrompt{T}"/> wrapping a <see cref="TableSelectResult{T}"/> that contains
        ...
        /// </summary>
        /// <param name="styleType">The <see cref="TableSelectStyles"/> element whose style is overridden.</param>
...
#pragma warning restore CA1716 // Identifiers should not match keywords
        ...
        /// <see cref="ITableSelectControl{T}"/> instance. Cannot be <see langword="null"/>.
        /// </param>
        /// <returns>The current <see cref="ITableSelectControl{T}"/> instance for chaining.</returns>
