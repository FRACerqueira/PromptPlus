...
{
    /// <summary>
    /// Represents the result returned by the <see cref="ITableSelectControl{T}"/> control.
    /// </summary>
    ...
    public readonly struct TableSelectResult<T>(T value, int rowIndex, int columnIndex)
    {
        /// <summary>
        /// Selected row value.
        /// </summary>
        ...
        /// <summary>
        /// Deconstructs the <see cref="TableSelectResult{T}"/> into components.
        /// </summary>
