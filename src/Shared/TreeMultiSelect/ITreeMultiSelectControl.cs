...
#pragma warning restore IDE0130 // Namespace does not match folder structure
{
    ...
    /// <remarks>
    /// The tree structure is built the same way as <see cref="ITreeSelectControl{T}"/>: via
    ...
    /// <see cref="AddBefore(ITreeNode{T}, T, bool, bool)"/> and the <see cref="ITreeMultiSelectNode{T}"/>
    ...
    /// <see cref="AddFirst(T, bool, bool)"/>/<see cref="AddAfter(ITreeNode{T}, T, bool, bool)"/>/
    /// <see cref="AddBefore(ITreeNode{T}, T, bool, bool)"/> return <see cref="ITreeMultiSelectNode{T}"/>
    ...
    public interface ITreeMultiSelectControl<T>
    {
        ...
        /// <summary>Overrides a style region for the TreeMultiSelect control.</summary>
        ...
        /// <returns>The same <see cref="ITreeMultiSelectControl{T}"/> instance for chaining.</returns>
