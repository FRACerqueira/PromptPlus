...
#pragma warning restore IDE0130 // Namespace does not match folder structure
{
    ...
    public interface ITreeSelectControl<T>
    {
        ...
        /// <summary>Overrides visual styles for a specific region of the TreeSelect control.</summary>
        ...
        ITreeSelectControl<T> Root(T value, bool disable = false);
...
#pragma warning restore CA1716 // Identifiers should not match keywords
        ...
        /// <summary>
        /// Asynchronous counterpart of <see cref="Interaction{T1}(IEnumerable{T1}, Action{T1, ITreeSelectControl{T}})"/>.
        ...
        /// <summary>Displays the TreeSelect control and blocks until the user confirms or cancels.</summary>
