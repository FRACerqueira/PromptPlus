...
namespace PromptPlusLibrary.Controls.TableMultiSelect
{
    ...
    internal sealed class TableMultiSelectControl<T> : BaseControlPrompt<T[]>, ITableMultiSelectControl<T>
    {
        ...
        private readonly Dictionary<TableMultiSelectStyles, Style> _optStyles;
        ...
        public TableMultiSelectControl(IConsole console, PromptConfig promptConfig, BaseControlOptions baseControlOptions)
            : base(false, console, promptConfig, baseControlOptions)
        {
            _optStyles = OptionsControl.LoadStyle<TableMultiSelectStyles>(console.CurrentStyle);
        ...
        #region ITableMultiSelectControl

        /// <inheritdoc/>
        public ITableMultiSelectControl<T> Options(Action<IControlOptions> options)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> Styles(TableMultiSelectStyles styleType, Style style)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> LayoutMode(TableLayoutMode mode)
        {
            _layoutMode = mode;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> HideElements(HideTable borders)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> HorizontalScroll(HorizontalScrollMode mode)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> AddColumn(string header, Func<T, object> selector, Func<object, string>? formatter = null, int? width = null, ColumnAlignment alignment = ColumnAlignment.Left, bool isFilterable = false)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> PageSize(byte value)
        {
            _pageSize = value;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> Filter(FilterMode value, FilterTableMode filterby = FilterTableMode.Answer)
        {
            _filterType = value;
            _filterBy = filterby;
            return this;
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> AddItem(T value, bool ischecked = false, bool disable = false)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> AddItems(IEnumerable<T> values, bool ischecked = false, bool disable = false)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> Default(IEnumerable<T> values)
        {
            ArgumentNullException.ThrowIfNull(values);
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> Range(int minvalue, int? maxvalue = null)
        {
            if (minvalue < 0)
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> PredicateChecked(Func<T, bool> validselect)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> PredicateCheckedAsync(Func<T, Task<bool>> validselect)
        {
            ArgumentNullException.ThrowIfNull(validselect);
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> PredicateChecked(Func<T, (bool, string?)> validselect)
        {
            ArgumentNullException.ThrowIfNull(validselect);
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> PredicateCheckedAsync(Func<T, Task<(bool, string?)>> validselect)
        {
            ArgumentNullException.ThrowIfNull(validselect);
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> DefaultMatchBy(Func<T, T, bool> comparer)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> EnableHistory(string filename, Action<IHistoryOptions>? options = null)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> UseDefaultHistory()
        {
            _defaultValues = [];
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> ChangeDescription(Func<T, string> value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> ChangeDescriptionAsync(Func<T, Task<string>> value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> TextSelector(Func<T, string> value)
        {
            ArgumentNullException.ThrowIfNull(value);
            _textSelector = value;
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> TextSelectorAsync(Func<T, Task<string>> value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> ViewOnly(bool value = true)
        {
            _viewOnly = value;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> Interaction<T1>(IEnumerable<T1> items, Action<T1, ITableMultiSelectControl<T>> interactionAction)
        {
        ...
        /// <inheritdoc/>
        public ITableMultiSelectControl<T> InteractionAsync<T1>(IEnumerable<T1> items, Func<T1, ITableMultiSelectControl<T>, Task> interactionAction)
        {
            ArgumentNullException.ThrowIfNull(items);
            ArgumentNullException.ThrowIfNull(interactionAction);
            foreach (T1 item in items)
        ...
        {
            if (_columns.Count == 0)
                throw new ValidationException("At least one column must be defined for the TableMultiSelect control.");
            if (_items.Count == 0)
        ...
        public override void BufferTemplate(BufferScreen screenBuffer)
        {
            ...
            WritePrompt(screenBuffer, _optStyles[TableMultiSelectStyles.Prompt]);
            WriteAnswer(screenBuffer);
            WriteDescription(screenBuffer);
            WriteTable(screenBuffer);
            WriteTooltip(screenBuffer);
            WriteError(screenBuffer, _optStyles[TableMultiSelectStyles.Error]);
        }
        ...
        public override bool FinishTemplate(BufferScreen screenBuffer)
        {
            ...
            {
                screenBuffer.WriteLine(PromptPlusResources.CanceledKey, _optStyles[TableMultiSelectStyles.Answer]);
            }
            else
            {
                ...
                screenBuffer.WriteLine(answer, _optStyles[TableMultiSelectStyles.Answer]);
            }
            return true;
        }
        ...
        private void LoadTooltipToggle()
        {
            foreach (ModeView mode in Enum.GetValues<ModeView>())
            {
                ...
                if (mode == ModeView.Select)
                {
                    ...
                    // silently does nothing (same fix as TableSelectControl).
        ...
        private void WriteAnswer(BufferScreen screenBuffer)
        {
            if (_modeView == ModeView.Select)
            {
                ...
                screenBuffer.Write(visibleLeft, _optStyles[TableMultiSelectStyles.Answer]);
                screenBuffer.SavePromptCursor();
                screenBuffer.WriteLine(visibleRight, _optStyles[TableMultiSelectStyles.Answer]);
            }
            else
            {
        ...
        private void WriteAnswerFilter(BufferScreen screenBuffer)
        {
            Style found = _localpaginator!.TotalCount == 0
                ? _optStyles[TableMultiSelectStyles.Error]
                : _optStyles[TableMultiSelectStyles.TaggedInfo];
            int promptWidth = GetPromptDisplayWidth();
            ...
            screenBuffer.WriteLine($" ({PromptPlusResources.Filter})", _optStyles[TableMultiSelectStyles.TaggedInfo]);
        }
        ...
        private void WriteDescription(BufferScreen screenBuffer)
        {
            ...
            if (!string.IsNullOrEmpty(desc))
                screenBuffer.WriteLine(desc, _optStyles[TableMultiSelectStyles.Description]);
        }
        ...
        private void WriteTooltip(BufferScreen screenBuffer)
        {
            ...
            if (!tooltip.EndsWith('.'))
                tooltip = $"{tooltip}.";
            screenBuffer.WriteLine(tooltip, _optStyles[TableMultiSelectStyles.Tooltips]);
        }
        ...
        private void WriteTable(BufferScreen screenBuffer)
        {
            ...
            {
                screenBuffer.Write(_cachedTopMain,    _optStyles[TableMultiSelectStyles.BorderLines]);
                screenBuffer.WriteLine(_cachedTopPreview, _optStyles[TableMultiSelectStyles.DisabledRow]);
            }
            ...
            if (!_layoutBorders.HasFlag(HideTable.Header))
            {
                ...
                {
                    screenBuffer.Write(_cachedHeaderSepMain,    _optStyles[TableMultiSelectStyles.BorderLines]);
                    screenBuffer.WriteLine(_cachedHeaderSepPreview, _optStyles[TableMultiSelectStyles.DisabledRow]);
                }
            }
            ...
            {
                screenBuffer.Write(_cachedBottomMain,    _optStyles[TableMultiSelectStyles.BorderLines]);
                screenBuffer.WriteLine(_cachedBottomPreview, _optStyles[TableMultiSelectStyles.DisabledRow]);
            }
            ...
            if (_localpaginator!.PageCount > 0)
            {
                ...
                screenBuffer.WriteLine(string.Concat(template, colInfo), _optStyles[TableMultiSelectStyles.Pagination]);
            }
        }
        ...
        private void WriteHeader(BufferScreen screenBuffer)
        {
            ...
            screenBuffer.Write(_cachedBorderPrefix, _optStyles[TableMultiSelectStyles.BorderLines]);
            ...
            if (_layoutMode != TableLayoutMode.None)
            {
                ...
                screenBuffer.Write(borderLeft, _optStyles[TableMultiSelectStyles.BorderLines]);
            }
            ...
            screenBuffer.Write(checkboxHeaderCell, _optStyles[TableMultiSelectStyles.HeaderText]);
            // Separator between checkbox column and first user column
            screenBuffer.Write(separator, _optStyles[TableMultiSelectStyles.BorderLines]);
            ...
            for (int i = _visibleStartCol; i <= _visibleEndCol; i++)
            {
                ...
                screenBuffer.Write(cell, showSelection ? _optStyles[TableMultiSelectStyles.SelectedCell] : _optStyles[TableMultiSelectStyles.HeaderText]);
            }

            if (_previewColumnIndex >= 0)
            {
                ColumnDefinition<T> previewCol = _columns[_previewColumnIndex];
                screenBuffer.Write(separator, _optStyles[TableMultiSelectStyles.DisabledRow]);
                ...
                screenBuffer.Write(previewCell, _optStyles[TableMultiSelectStyles.DisabledRow]);
            }
            ...
            if (_layoutMode != TableLayoutMode.None)
            {
                ...
                screenBuffer.Write(borderRight, _optStyles[TableMultiSelectStyles.BorderLines]);
            }
        ...
        private void WriteDataRows(BufferScreen screenBuffer)
        {
            ...
            foreach (ItemTable<T> item in subset)
            {
                ...
                Style rowStyle = item.Disabled
                    ? _optStyles[TableMultiSelectStyles.DisabledRow]
                    : (isSelectedRow ? _optStyles[TableMultiSelectStyles.SelectedCell] : _optStyles[TableMultiSelectStyles.UnselectedCell]);

                // ── Selector prefix (outside the table border) ─────────────────
                if (isSelectedRow)
                    screenBuffer.Write(selectorSym, _optStyles[TableMultiSelectStyles.SelectedCell]);
                else
                ...
                {
                    screenBuffer.Write(_cachedRowSepMain,    _optStyles[TableMultiSelectStyles.BorderLines]);
                    screenBuffer.WriteLine(_cachedRowSepPreview, _optStyles[TableMultiSelectStyles.DisabledRow]);
                }
            }
        }
