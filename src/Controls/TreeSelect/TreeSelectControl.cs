...
namespace PromptPlusLibrary.Controls.TreeSelect
{
    /// <inheritdoc/>
    internal sealed class TreeSelectControl<T> : BaseControlPrompt<T?>, ITreeSelectControl<T>
    {
        /// <summary>
        ...
        private readonly Dictionary<TreeSelectStyles, Style> _optStyles;
        ...
        public TreeSelectControl(IConsole console, PromptConfig promptConfig, BaseControlOptions baseControlOptions)
            : base(false, console, promptConfig, baseControlOptions)
        {
            _optStyles = OptionsControl.LoadStyle<TreeSelectStyles>(console.CurrentStyle);
            _pageSize = ConfigPrompt.PageSize;
        }

        #region ITreeSelectControl<T>

        /// <inheritdoc/>
        public ITreeSelectControl<T> Options(Action<IControlOptions> options)
        {
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> Styles(TreeSelectStyles styleType, Style style)
        {
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> Root(T value, bool disable = false)
        {
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> TextSelector(Func<T, string> selector)
        {
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> ExtraInfo(Func<T, string?> extraInfoNode)
        {
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> ExtraInfoAsync(Func<T, Task<string?>> extraInfoNode)
        {
            ArgumentNullException.ThrowIfNull(extraInfoNode);
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> PathSeparator(char value)
        {
            _pathSep = value;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> PageSize(byte value)
        {
            _pageSize = value;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> SelectLeafOnly(bool value = true)
        {
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> ShowFullPath(bool value = true)
        {
            _showFullPath = value;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> DefaultMatchBy(Func<T, T, bool> comparer)
        {
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> Default(T value, bool useDefaultHistory = true)
        {
            ArgumentNullException.ThrowIfNull(value);
            _defaultValue = value;
            _hasDefault = true;
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> EnableHistory(string filename, Action<IHistoryOptions>? options = null)
        {
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> ViewOnly(bool value = true)
        {
            _viewOnly = value;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> ChangeDescription(Func<T, string> value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> ChangeDescriptionAsync(Func<T, Task<string>> value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> Filter(FilterMode value)
        {
            _filterType = value;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> PredicateSelected(Func<T, bool> validselect)
        {
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> PredicateSelected(Func<T, (bool, string?)> validselect)
        {
            ArgumentNullException.ThrowIfNull(validselect);
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> PredicateSelectedAsync(Func<T, Task<bool>> validselect)
        {
            ArgumentNullException.ThrowIfNull(validselect);
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> PredicateSelectedAsync(Func<T, Task<(bool, string?)>> validselect)
        {
            ArgumentNullException.ThrowIfNull(validselect);
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> Interaction<T1>(IEnumerable<T1> items, Action<T1, ITreeSelectControl<T>> interactionAction)
        {
        ...
        /// <inheritdoc/>
        public ITreeSelectControl<T> InteractionAsync<T1>(IEnumerable<T1> items, Func<T1, ITreeSelectControl<T>, Task> interactionAction)
        {
            ArgumentNullException.ThrowIfNull(items);
            ArgumentNullException.ThrowIfNull(interactionAction);
            foreach (T1 item in items)
        ...
        public override void InitControl(CancellationToken cancellationToken)
        {
            if (_root is null)
            {
                throw new InvalidOperationException("TreeSelect control requires a Root value.");
            }
            if (_textSelector is null)
            {
                throw new InvalidOperationException("TreeSelect control requires a TextSelector.");
            }
            if (_equals is null)
            {
                throw new InvalidOperationException("TreeSelect control requires DefaultMatchBy.");
            }
        ...
        public override void BufferTemplate(BufferScreen screenBuffer)
        {
            ...
            WritePrompt(screenBuffer, _optStyles[TreeSelectStyles.Prompt]);
            WriteAnswer(screenBuffer);
            WriteDescription(screenBuffer);
            WriteTreeList(screenBuffer);
            WriteTooltip(screenBuffer);
            WriteError(screenBuffer, _optStyles[TreeSelectStyles.Error]);
        }
        ...
        public override bool FinishTemplate(BufferScreen screenBuffer)
        {
            ...
            screenBuffer.WriteLine(answer, _optStyles[TreeSelectStyles.Answer]);
            return true;
        }
        ...
        private void WriteAnswer(BufferScreen screenBuffer)
        {
            ...
            WriteAnswerViewport(screenBuffer, text, _optStyles[TreeSelectStyles.Answer]);
        }

        private void WriteAnswerFilter(BufferScreen screenBuffer)
        {
            Style found = _localpaginator!.TotalCount == 0 ? _optStyles[TreeSelectStyles.Error] : _optStyles[TreeSelectStyles.Answer];
            ...
            screenBuffer.WriteLine($" ({PromptPlusResources.Filter})", _optStyles[TreeSelectStyles.ChildsCount]);
        }
        ...
        private void WriteDescription(BufferScreen screenBuffer)
        {
            ...
            {
                screenBuffer.WriteLine(desc, _optStyles[TreeSelectStyles.Description]);
            }
        }
        ...
        private void WriteTreeList(BufferScreen screenBuffer)
        {
            ...
            foreach (VNode node in subset)
            {
                ...
                Style lineStyle = isSelected ? _optStyles[TreeSelectStyles.Selected] : _optStyles[TreeSelectStyles.UnSelected];
                ...
                if (_modeView == ModeView.Filter)
                {
                    ...
                    Style nameStyle = node.Disabled ? _optStyles[TreeSelectStyles.Disabled]
                        : isSelected ? lineStyle
                        : node.IsRoot ? _optStyles[TreeSelectStyles.Root] : _optStyles[TreeSelectStyles.Node];
                    ...
                    if (_extraInfoSelector != null || _extraInfoSelectorAsync != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(extra))
                        {
                            screenBuffer.Write($"  {extra}", _optStyles[TreeSelectStyles.ChildsCount]);
                        }
                    }
                ...
                if (node.Depth > 0)
                {
                    for (int d = 1; d < node.Depth; d++)
                    {
                        screenBuffer.Write((node.AncestorMask & (1L << d)) != 0
                            ...
                            : GetSymbol(SymbolType.TreeLinespace), _optStyles[TreeSelectStyles.Lines]);
                    }
                    screenBuffer.Write(node.IsLast
                        ? GetSymbol(SymbolType.TreeLinecorner)
                        : GetSymbol(SymbolType.TreeLinecross), _optStyles[TreeSelectStyles.Lines]);
                }
                ...
                if (node.HasChildren)
                {
                    screenBuffer.Write(node.IsExpanded
                        ...
                        : GetSymbol(SymbolType.Collapsed), _optStyles[TreeSelectStyles.ExpandSymbol]);
                    screenBuffer.Write(" ", ConsoleHandler.CurrentStyle);
                }

                Style nameStyleSelect = node.IsRoot
                    ? _optStyles[TreeSelectStyles.Root]
                    : node.HasChildren ? _optStyles[TreeSelectStyles.Node] : _optStyles[TreeSelectStyles.Node];
                if (isSelected)
                {
                ...
                if (node.Disabled)
                {
                    nameStyleSelect = _optStyles[TreeSelectStyles.Disabled];
                }
            ...
            if (_localpaginator.PageCount > 0)
            {
                ...
                screenBuffer.WriteLine(template, _optStyles[TreeSelectStyles.Pagination]);
            }
        }
        ...
        private void WriteTooltip(BufferScreen screenBuffer)
        {
            ...
            screenBuffer.WriteLine(tooltip, _optStyles[TreeSelectStyles.Tooltips]);
        }
