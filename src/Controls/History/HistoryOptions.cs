...
namespace PromptPlusLibrary.Controls.History
{
    ...
    internal sealed class HistoryOptions(string filename) : IHistoryOptions
    {
        ...
        private byte _minPrefixLength;
        private FilterMode _filtertype = FilterMode.Contains;
        ...
        /// <summary>
        /// Gets the filter mode used for matching history items.
        /// </summary>
        public FilterMode FilterTypeValue => _filtertype;
        ...
        public IHistoryOptions FilterType(FilterMode value)
        {
            _filtertype = value;
            return this;
        }
