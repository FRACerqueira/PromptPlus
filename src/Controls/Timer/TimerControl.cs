...
namespace PromptPlusLibrary.Controls.Timer
{
    /// <inheritdoc/>
    internal sealed class TimerControl : BaseControlPrompt<TimeSpan>, ITimerControl
    {
        /// <summary>
        /// The Timer control renders automatically (countdown ticking) by firing simulated key
        ...
        private readonly Dictionary<TimerStyles, Style> _optStyles;
        private readonly Stopwatch _stopwatch = new();
        private readonly Stopwatch _spinnerTimer = new();
        private CultureInfo _culture;
        private TimeSpan _duration = TimeSpan.Zero;
        private string _format = @"hh\:mm\:ss";
        private TimerDisplayMode _displayMode = TimerDisplayMode.Countdown;
        ...
        public TimerControl(IConsole console, PromptConfig promptConfig, BaseControlOptions baseControlOptions) : base(false, console, promptConfig, baseControlOptions)
        {
            _optStyles = OptionsControl.LoadStyle<TimerStyles>(console.CurrentStyle);
            _culture = ConfigPrompt.DefaultCulture;
        }

        #region ITimerControl

        /// <inheritdoc/>
        public ITimerControl Options(Action<IControlOptions> options)
        {
        ...
        /// <inheritdoc/>
        public ITimerControl Styles(TimerStyles styleType, Style style)
        {
        ...
        /// <inheritdoc/>
        public ITimerControl Duration(TimeSpan duration)
        {
        ...
        /// <inheritdoc/>
        public ITimerControl Duration(int seconds)
        {
            if (seconds <= 0)
            {
        ...
        /// <inheritdoc/>
        public ITimerControl Format(string format)
        {
        ...
        /// <inheritdoc/>
        public ITimerControl Culture(CultureInfo culture)
        {
        ...
        /// <inheritdoc/>
        public ITimerControl Finish(string finishtext)
        {
        ...
        /// <inheritdoc/>
        public ITimerControl ChangeDescription(Func<TimeSpan, string> value)
        {
        ...
        /// <inheritdoc/>
        public ITimerControl ChangeDescriptionAsync(Func<TimeSpan, Task<string>> value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <inheritdoc/>
        public ITimerControl DisplayMode(TimerDisplayMode mode)
        {
            _displayMode = mode;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITimerControl Spinner(SpinnersType spinnersType)
        {
        ...
        {
            WritePrompt(screenBuffer, _optStyles[TimerStyles.Prompt]);
        ...
        public override bool FinishTemplate(BufferScreen screenBuffer)
        {
            ...
            string answer;
            Style styleanswer = _optStyles[TimerStyles.Answer];
        ...
        /// <summary>
        /// Gets the time value to display according to the configured <see cref="TimerDisplayMode"/>.
        /// </summary>
        private TimeSpan DisplayValue()
            => _displayMode == TimerDisplayMode.Elapsed ? Elapsed() : Remaining();
        ...
        private void WriteAnswer(BufferScreen screenBuffer)
        {
            ...
            screenBuffer.Write(answer, _optStyles[TimerStyles.Answer]);
            if (_spinner != null)
            {
                screenBuffer.Write($" {_spinner.CurrentFrame}", _optStyles[TimerStyles.Spinner]);
            }
            screenBuffer.SavePromptCursor();
            screenBuffer.WriteLine("", _optStyles[TimerStyles.Answer]);
        }
        ...
        private void WriteDescription(BufferScreen screenBuffer)
        {
            ...
            {
                screenBuffer.WriteLine(desc, _optStyles[TimerStyles.Description]);
            }
        }
        ...
        private void WriteTooltip(BufferScreen screenBuffer)
        {
            ...
            screenBuffer.WriteLine(tooltip, _optStyles[TimerStyles.Tooltips]);
        }
