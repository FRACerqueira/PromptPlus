...
{
    /// <inheritdoc/>
    internal sealed class TableSelectControl<T> : BaseControlPrompt<TableSelectResult<T>>, ITableSelectControl<T>
    {
        /// <summary>
        ...
        private readonly Dictionary<TableSelectStyles, Style> _optStyles;
        ...
        public TableSelectControl(IConsole console, PromptConfig promptConfig, BaseControlOptions baseControlOptions)
            : base(false, console, promptConfig, baseControlOptions)
        {
            _optStyles = OptionsControl.LoadStyle<TableSelectStyles>(console.CurrentStyle);
        ...
        #region ITableSelectControl

        /// <inheritdoc/>
        public ITableSelectControl<T> Options(Action<IControlOptions> options)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> Styles(TableSelectStyles styleType, Style style)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> LayoutMode(TableLayoutMode mode)
        {
            _layoutMode = mode;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> HideElements(HideTable borders)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> HorizontalScroll(HorizontalScrollMode mode)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> AddColumn(string header, Func<T, object> selector, Func<object, string>? formatter = null, int? width = null, ColumnAlignment alignment = ColumnAlignment.Left, bool isFilterable = false)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> PageSize(byte value)
        {
            _pageSize = value;
            return this;
        }
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> Filter(FilterMode value, FilterTableMode filterby = FilterTableMode.Answer)
        {
            _filterType = value;
            _filterBy = filterby;
            return this;
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> PredicateSelected(Func<T, bool> validselect)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> PredicateSelectedAsync(Func<T, Task<bool>> validselect)
        {
            ArgumentNullException.ThrowIfNull(validselect);
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> PredicateSelected(Func<T, (bool, string?)> validselect)
        {
            ArgumentNullException.ThrowIfNull(validselect);
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> PredicateSelectedAsync(Func<T, Task<(bool, string?)>> validselect)
        {
            ArgumentNullException.ThrowIfNull(validselect);
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> DefaultMatchBy(Func<T, T, bool> comparer)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> AddItem(T value, bool disable = false)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> AddItems(IEnumerable<T> values, bool disable = false)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> Default(T value, bool useDefaultHistory = true)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> EnableHistory(string filename, Action<IHistoryOptions>? options = null)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> UseDefaultHistory()
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> ChangeDescription(Func<T, string> value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> ChangeDescriptionAsync(Func<T, Task<string>> value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> Interaction<T1>(IEnumerable<T1> items, Action<T1, ITableSelectControl<T>> interactionAction)
        {
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> InteractionAsync<T1>(IEnumerable<T1> items, Func<T1, ITableSelectControl<T>, Task> interactionAction)
        {
            ArgumentNullException.ThrowIfNull(items);
            ArgumentNullException.ThrowIfNull(interactionAction);
            foreach (T1 item in items)
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> TextSelector(Func<T, string> value)
        {
            ArgumentNullException.ThrowIfNull(value);
            _textSelector = value;
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> TextSelectorAsync(Func<T, Task<string>> value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <inheritdoc/>
        public ITableSelectControl<T> ViewOnly(bool value = true)
        {
            _viewOnly = value;
            return this;
        }
        ...
        public override void InitControl(CancellationToken cancellationToken)
        {
            if (_columns.Count == 0)
            {
                throw new ValidationException("At least one column must be defined for the TableSelect control.");
            }
            ...
            try
            {
                ...
                while (!cancellationToken.IsCancellationRequested)
                {
                    ...
                    if (press.IsResize || press.IsCancelled)
                    {
                        ...
                        {
                            _indexTooptip = 0;
                            ResultCtrl = new ResultPrompt<TableSelectResult<T>>(default!, true);
                        }
                        break;
                    }
                    ...
                    if (IsAbortKeyPress(keyinfo))
                    {
                        ...
                        if (_viewOnly)
                        {
                            ...
                            ResultCtrl = viewItem != null
                                ? new ResultPrompt<TableSelectResult<T>>(new TableSelectResult<T>(viewItem.Value, _initialRowIndex, _initialColumnIndex), true)
                                : new ResultPrompt<TableSelectResult<T>>(default!, true);
                        }
                        else
                        {
                            ResultCtrl = _localpaginator!.SelectedItem != null
                                ? new ResultPrompt<TableSelectResult<T>>(new TableSelectResult<T>(_localpaginator.SelectedItem.Value!, _localpaginator.CurrentIndex, _currentColumnIndex), true)
                                : new ResultPrompt<TableSelectResult<T>>(default!, true);
                        }
                        break;
                    }
                    ...
                    else if (keyinfo.IsPressEnterKey() && _localpaginator!.SelectedItem != null)
                    {
                        ...
                        if (_viewOnly)
                        {
                            ...
                            var viewItem = _initialItem ?? _localpaginator!.SelectedItem;
                            ResultCtrl = new ResultPrompt<TableSelectResult<T>>(new TableSelectResult<T>(viewItem.Value, _initialRowIndex, _initialColumnIndex), false);
                            break;
                        }
                        ...
                        _modeView = ModeView.Select;
                        ResultCtrl = new ResultPrompt<TableSelectResult<T>>(new TableSelectResult<T>(_localpaginator!.SelectedItem.Value, _localpaginator.CurrentIndex, _currentColumnIndex), false);
        ...
        public override void BufferTemplate(BufferScreen screenBuffer)
        {
            ...
            WritePrompt(screenBuffer, _optStyles[TableSelectStyles.Prompt]);
            WriteAnswer(screenBuffer);
            WriteDescription(screenBuffer);
            WriteTable(screenBuffer);
            WriteTooltip(screenBuffer);
            WriteError(screenBuffer, _optStyles[TableSelectStyles.Error]);
        }
        ...
        public override bool FinishTemplate(BufferScreen screenBuffer)
        {
            ...
            if (!_viewOnly)
            {
                screenBuffer.WriteLine(answer, _optStyles[TableSelectStyles.Answer]);
            }
            else
            {
                if (_defaultValue.HasValue)
                {
                    ...
                    if (found is not null)
                        {
                            screenBuffer.WriteLine(GetAnswerText(found), _optStyles[TableSelectStyles.Answer]);
                        }
                }
                else
                {
                    if (_initialItem is not null)
                        {
                            screenBuffer.WriteLine(GetAnswerText(_initialItem), _optStyles[TableSelectStyles.Answer]);
                        }
                }
            }
            return true;
        ...
        private void WriteDescription(BufferScreen screenBuffer)
        {
            ...
            {
                screenBuffer.WriteLine(desc, _optStyles[TableSelectStyles.Description]);
            }
        }
        ...
        private void WriteTable(BufferScreen screenBuffer)
        {
            ...
            {
                screenBuffer.Write(_cachedTopMain, _optStyles[TableSelectStyles.BorderLines]);
                screenBuffer.WriteLine(_cachedTopPreview, _optStyles[TableSelectStyles.DisabledRow]);
            }
            ...
            if (!_layoutBorders.HasFlag(HideTable.Header))
            {
                ...
                {
                    screenBuffer.Write(_cachedHeaderSepMain, _optStyles[TableSelectStyles.BorderLines]);
                    screenBuffer.WriteLine(_cachedHeaderSepPreview, _optStyles[TableSelectStyles.DisabledRow]);
                }
            }
            ...
            {
                screenBuffer.Write(_cachedBottomMain, _optStyles[TableSelectStyles.BorderLines]);
                screenBuffer.WriteLine(_cachedBottomPreview, _optStyles[TableSelectStyles.DisabledRow]);
            }
            ...
            if (_localpaginator!.PageCount > 0)
            {
                ...
                screenBuffer.WriteLine(string.Concat(template, colInfo), _optStyles[TableSelectStyles.Pagination]);
            }
        }
        ...
        private void WriteAnswer(BufferScreen screenBuffer)
        {
            if (_modeView == ModeView.Select)
            {
                ...
                screenBuffer.Write(visibleLeft, _optStyles[TableSelectStyles.Answer]);
                screenBuffer.SavePromptCursor();
                screenBuffer.WriteLine(visibleRight, _optStyles[TableSelectStyles.Answer]);
            }
        ...
        {
            Style found = _optStyles[TableSelectStyles.TaggedInfo];
            if (_localpaginator!.TotalCount == 0)
            {
                found = _optStyles[TableSelectStyles.Error];
            }
            int promptWidth = GetPromptDisplayWidth();
            ...
            screenBuffer.WriteLine($" ({PromptPlusResources.Filter})", _optStyles[TableSelectStyles.TaggedInfo]);
        }
        ...
        private void WriteTooltip(BufferScreen screenBuffer)
        {
            ...
            screenBuffer.WriteLine(tooltip, _optStyles[TableSelectStyles.Tooltips]);
        }
        ...
        private void WriteHeader(BufferScreen screenBuffer)
        {
            ...
            screenBuffer.Write("  ", _optStyles[TableSelectStyles.BorderLines]);
            ...
            if (_layoutMode != TableLayoutMode.None)
            {
                ...
                screenBuffer.Write(borderLeft, _optStyles[TableSelectStyles.BorderLines]);
            }
            ...
            for (int i = _visibleStartCol; i <= _visibleEndCol; i++)
            {
                ...
                {
                    screenBuffer.Write(separator, _optStyles[TableSelectStyles.BorderLines]);
                }
                ...
                screenBuffer.Write(cell, showSelection ? _optStyles[TableSelectStyles.SelectedCell] : _optStyles[TableSelectStyles.HeaderText]);
            }

            if (_previewColumnIndex >= 0)
            {
                ColumnDefinition<T> previewCol = _columns[_previewColumnIndex];
                screenBuffer.Write(separator, _optStyles[TableSelectStyles.DisabledRow]);
                ...
                screenBuffer.Write(previewCell, _optStyles[TableSelectStyles.DisabledRow]);
            }
            ...
            if (_layoutMode != TableLayoutMode.None)
            {
                ...
                screenBuffer.Write(borderRight, _optStyles[TableSelectStyles.BorderLines]);
            }
        ...
        private void WriteDataRows(BufferScreen screenBuffer)
        {
            ...
            foreach (ItemTable<T> item in subset)
            {
                ...
                Style rowTextStyle = (item.Disabled
                    ? _optStyles[TableSelectStyles.DisabledRow]
                    : (isSelectedRow ? _optStyles[TableSelectStyles.SelectedCell] : _optStyles[TableSelectStyles.UnselectedCell]));
                ...
                if (_previewColumnIndex >= 0)
                {
                    ...
                    screenBuffer.Write(previewCellText, _optStyles[TableSelectStyles.DisabledRow]);
                }
                ...
                {
                    screenBuffer.Write(_cachedRowSepMain, _optStyles[TableSelectStyles.BorderLines]);
                    screenBuffer.WriteLine(_cachedRowSepPreview, _optStyles[TableSelectStyles.DisabledRow]);
                }
            }
        }
        ...
        private void WriteRowPrefix(BufferScreen screenBuffer, bool isSelectedRow)
        {
            if (isSelectedRow)
            {
                screenBuffer.Write(GetSymbol(SymbolType.Selector)[0], _optStyles[TableSelectStyles.SelectedCell]);
                screenBuffer.Write(" ", _optStyles[TableSelectStyles.BorderLines]);
            }
            else
            {
