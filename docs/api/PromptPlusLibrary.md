...
| [ITreeNode&lt;T&gt;](ITreeNode_T_.md 'PromptPlusLibrary\.ITreeNode\<T\>') | Represents a node of the tree exposed by the [ITreeControl&lt;T&gt;](ITreeControl_T_.md 'PromptPlusLibrary\.ITreeControl\<T\>') when it is being constructed\. A node carries a user value and can have any number of children added lazily through [AddLast\(T\)](ITreeNode_T_.md#PromptPlusLibrary.ITreeNode_T_.AddLast(T) 'PromptPlusLibrary\.ITreeNode\<T\>\.AddLast\(T\)') and [AddFirst\(T\)](ITreeNode_T_.md#PromptPlusLibrary.ITreeNode_T_.AddFirst(T) 'PromptPlusLibrary\.ITreeNode\<T\>\.AddFirst\(T\)')\. |
