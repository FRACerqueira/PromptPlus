...
[← Back to Home](../../../README.md) • **Next:** [MultiTree Control →](../multitree/index.md)

---

`Tree<T>` paints its output in named regions. Each region is a `TreeStyles` value you can recolor
...
- [MultiTree → Styles](../multitree/styles.md) — the multiple-choice sibling
