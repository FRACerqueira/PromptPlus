...
[← Back to Home](../../../README.md) • **Next:** [Tree Control →](../tree/index.md)

---

`MultiTable<T>` paints its output in named regions. Each region is a `MultiTableStyles` value you can
...
PromptPlus.Controls
    .MultiTable<Product>("Select products")
...
- [Table → Styles](../table/styles.md) — the `TableStyles` regions
