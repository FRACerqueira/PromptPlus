...
> ☑️ Only need **one** row? Use the [**Table**](../table/index.md) control — same grid model, single choice.
...
| Restrict what can be checked | `PredicateSelected`, `PredicateSelectedAsync` |
