...
[← Back to Home](../../../README.md) • **Next:** [MultiFile Control →](../multifile/index.md)

---

`File` paints its output in named regions. Each region is a `FileStyles` value you can recolor per
control instance.
...
- [Visual Symbols](../../visual-symbols.md) — the focus arrow and tree symbols these styles color
- [MultiFile → Styles](../multifile/styles.md) — adds the `TaggedInfo` region for checked-count info
