...
[← Back to Home](../../../README.md) • **Next:** [TreeSelect — Methods →](methods.md)
...
> ☑️ Need to check **several** nodes at once? Use the [**TreeMultiSelect**](../treemultiselect/index.md)
...
| [Styles](styles.md) | The `TreeSelectStyles` regions and how to recolor them |
...
| The user may check several nodes | [TreeMultiSelect](../treemultiselect/index.md) |
...
- `TreeSelect<string>("Pick a folder")` creates a tree of strings. The type argument `T` is the node type.
...
- [TreeMultiSelect](../treemultiselect/index.md) — multiple-choice sibling
- [Select](../select/index.md) · [TableSelect](../tableselect/index.md) — flat and tabular pickers
