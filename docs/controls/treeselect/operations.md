...
[← Back to Home](../../../README.md) • **Next:** [TreeSelect — Styles →](styles.md)

---

How the `TreeSelect<T>` control is built and how it behaves while running: the tree model, keyboard,
...
```csharp
var tree = PromptPlus.Controls.TreeSelect<Node>("Pick an item")
    .Root(company)
...
- [TreeMultiSelect → Operations](../treemultiselect/operations.md) — the multiple-choice sibling
