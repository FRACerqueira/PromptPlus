...
[← Back to Home](../../../README.md) • **Next:** [TreeMultiSelect Control →](../treemultiselect/index.md)

---

`TreeSelect<T>` paints its output in named regions. Each region is a `TreeSelectStyles` value you can recolor
...
| `Selected` | The focused / selected node |
| `UnSelected` | The non-focused nodes |
| `Disabled` | Nodes that cannot be confirmed (e.g., containers under `SelectLeafOnly`) |
...
- [Visual Symbols](../../visual-symbols.md) — the focus arrow and expand markers these styles color
- [Methods → Styles](methods.md#styles)
- [TreeMultiSelect → Styles](../treemultiselect/styles.md) — the multiple-choice sibling
