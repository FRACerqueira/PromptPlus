...
| [Extensions points](https://fracerqueira.github.io/PromptPlus/basemethods.md#sample-use-of-extraaction) | Input text with history/suguestions using extensions points |
