...
namespace PromptPlusControls
{
    internal class MaskedListControl : ControlBase<IEnumerable<ResultMasked>>, IControlListMasked
    {
        ...
        private void FmtData()
        {
            ...
            var yearlen = "4";
            if (_options.MaskedOption.FmtYear == PromptPlusObjects.FormatYear.Y2)
            {
                yearlen = "2";
            }
        ...
        private string CreateMaskedOnlyDate()
        {
            ...
            {
                PromptPlusObjects.FormatYear.Y4 => $"99\\{_options.MaskedOption.CurrentCulture.DateTimeFormat.DateSeparator}99\\{_options.MaskedOption.CurrentCulture.DateTimeFormat.DateSeparator}9999",
                PromptPlusObjects.FormatYear.Y2 => $"99\\{_options.MaskedOption.CurrentCulture.DateTimeFormat.DateSeparator}99\\{_options.MaskedOption.CurrentCulture.DateTimeFormat.DateSeparator}99",
        ...
        private string CreateMaskedOnlyTime()
        {
            ...
            {
                PromptPlusObjects.FormatTime.HMS => $"99\\{_options.MaskedOption.CurrentCulture.DateTimeFormat.TimeSeparator}99\\{_options.MaskedOption.CurrentCulture.DateTimeFormat.TimeSeparator}99",
                PromptPlusObjects.FormatTime.OnlyHM => $"99\\{_options.MaskedOption.CurrentCulture.DateTimeFormat.TimeSeparator}99\\{_options.MaskedOption.CurrentCulture.DateTimeFormat.TimeSeparator}00",
                PromptPlusObjects.FormatTime.OnlyH => $"99\\{_options.MaskedOption.CurrentCulture.DateTimeFormat.TimeSeparator}00\\{_options.MaskedOption.CurrentCulture.DateTimeFormat.TimeSeparator}00",
