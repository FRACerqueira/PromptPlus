...
namespace PromptPlusControls
{
    internal class MaskedInputControl : ControlBase<ResultMasked>, IControlMaskEdit
    {
        ...
        private void ConvertDefaultDateValue()
        {
            ...
            var yearlen = "4";
            if (_options.FmtYear == PromptPlusObjects.FormatYear.Y2)
            {
                yearlen = "2";
            }
            ...
            {
                case PromptPlusObjects.FormatYear.Y4:
                    break;
                case PromptPlusObjects.FormatYear.Y2:
        ...
        private string CreateMaskedOnlyDate()
        {
            ...
            {
                PromptPlusObjects.FormatYear.Y4 => $"99\\{_options.CurrentCulture.DateTimeFormat.DateSeparator}99\\{_options.CurrentCulture.DateTimeFormat.DateSeparator}9999",
                PromptPlusObjects.FormatYear.Y2 => $"99\\{_options.CurrentCulture.DateTimeFormat.DateSeparator}99\\{_options.CurrentCulture.DateTimeFormat.DateSeparator}99",
        ...
        private string CreateMaskedOnlyTime()
        {
            ...
            {
                PromptPlusObjects.FormatTime.HMS => $"99\\{_options.CurrentCulture.DateTimeFormat.TimeSeparator}99\\{_options.CurrentCulture.DateTimeFormat.TimeSeparator}99",
                PromptPlusObjects.FormatTime.OnlyHM => $"99\\{_options.CurrentCulture.DateTimeFormat.TimeSeparator}99\\{_options.CurrentCulture.DateTimeFormat.TimeSeparator}00",
                PromptPlusObjects.FormatTime.OnlyH => $"99\\{_options.CurrentCulture.DateTimeFormat.TimeSeparator}00\\{_options.CurrentCulture.DateTimeFormat.TimeSeparator}00",
