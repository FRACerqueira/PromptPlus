...
namespace PromptPlusInternal
{
    internal class ScreenRender
    {
        ...
        public static bool KeyAvailable => _consoleDriver.KeyAvailable;

        public static ConsoleKeyInfo KeyPressed => _consoleDriver.ReadKey(true);
        ...
        private void EnsureScreensizeAndPosition()
        {
            ...
            while (_consoleDriver.BufferHeight - 1 < ConsoleDriver.MinBufferHeight)
            {
                ...
                _ = _consoleDriver.WaitKeypress(true, StopToken);
                if (StopToken.IsCancellationRequested)
                {
                    return;
                }
