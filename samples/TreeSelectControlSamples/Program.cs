...
namespace TreeSelectControlSamples
{
    /// <summary>
    ...
    internal static class Program
    {
        private static void Main()
        {
            ...
            var t1 = PromptPlus.Controls.TreeSelect<Node>(
                    "Pick any item",
            ...
            var t2 = PromptPlus.Controls.TreeSelect<Node>("Notice the order of the top-level nodes")
                .Root(root)
                .TextSelector(n => n.Name)
                .DefaultMatchBy((a, b) => a.Id == b.Id);
            ...
            var t3 = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t4 = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t5 = PromptPlus.Controls.TreeSelect<Node>("The 'Database' leaf is pre-selected")
                .Root(root)
                .TextSelector(n => n.Name)
                .DefaultMatchBy((a, b) => a.Id == b.Id)
                .Default(database);
            ...
            var t6 = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t7a = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t7b = PromptPlus.Controls.TreeSelect<Node>(
            ...
            try
            {
                ...
                var t8First = PromptPlus.Controls.TreeSelect<Node>("Pick a node (will be remembered)")
                    .Root(root)
                    .TextSelector(n => n.Name)
                    .DefaultMatchBy((a, b) => a.Id == b.Id)
                ...
                var t8Second = PromptPlus.Controls.TreeSelect<Node>("Runs again (default comes from history)")
                    .Root(root)
                    .TextSelector(n => n.Name)
                    .DefaultMatchBy((a, b) => a.Id == b.Id)
                    .EnableHistory(historyKey);
            ...
            int nextId = 1000;
            var t9 = PromptPlus.Controls.TreeSelect<Node>(
                    "TreeSelect populated by Interaction<T1>",
            ...
            var t9Async = PromptPlus.Controls.TreeSelect<Node>("TreeSelect populated by InteractionAsync<T1>")
            ...
            var t10 = PromptPlus.Controls.TreeSelect<Node>("Fully customized rendering")
                .Root(root)
                .TextSelector(n => n.Name)
                .ExtraInfo(n => n.Info)
                .DefaultMatchBy((a, b) => a.Id == b.Id)
                .PageSize(10)
                .Styles(TreeSelectStyles.Prompt,       new Style(Color.Yellow,  Color.Black))
                .Styles(TreeSelectStyles.Root,         new Style(Color.Magenta, Color.Black))
                .Styles(TreeSelectStyles.Node,         new Style(Color.Cyan,    Color.Black))
                .Styles(TreeSelectStyles.ChildsCount,  new Style(Color.Gray,    Color.Black))
            ...
            var t11 = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t12 = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t13 = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t14 = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t15 = PromptPlus.Controls.TreeSelect<Node>("Async description (simulated I/O)")
                .Root(root)
                .TextSelector(n => n.Name)
                .DefaultMatchBy((a, b) => a.Id == b.Id)
            ...
            var t16 = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t17 = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t18 = PromptPlus.Controls.TreeSelect<Node>(
            ...
            var t18b = PromptPlus.Controls.TreeSelect<Node>(
        ...
        /// </summary>
        private static int PopulateGrouped(ITreeSelectControl<Node> ctrl, int groupCount, int itemsPerGroup, int startId)
        {
            int id = startId;
