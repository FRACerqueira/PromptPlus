...
namespace TableMultiSelectControlSamples;
...
internal static class Program
{
    ...
    static void Main()
    {
        ...
        var r1 = PromptPlus.Controls.TableMultiSelect<Product>("Select products", "Check all desired items")
        ...
        var r2 = PromptPlus.Controls.TableMultiSelect<Product>("Select 2 to 4 products", "Available items pre-checked")
        ...
        var r3 = PromptPlus.Controls.TableMultiSelect<Product>("Deselect products to exclude")
            .AddColumn("Name",     x => x.Name)
            .AddColumn("Category", x => x.Category)
            .AddColumn("Price",    x => x.Price, v => $"${v:N2}", alignment: ColumnAlignment.Right)
        ...
        var r4 = PromptPlus.Controls.TableMultiSelect<Product>("Select Electronics/Peripherals products")
            .AddColumn("Name",     x => x.Name)
            .AddColumn("Category", x => x.Category)
            .AddColumn("Price",    x => x.Price, v => $"${v:N2}", alignment: ColumnAlignment.Right)
            .AddItems(s_products)
        ...
        var r5 = PromptPlus.Controls.TableMultiSelect<Product>("Select products (stock > 50 only)")
            .AddColumn("Name",  x => x.Name)
        ...
        var r6 = PromptPlus.Controls.TableMultiSelect<Product>("Select available products (async check)")
            .AddColumn("Name",      x => x.Name)
            .AddColumn("Available", x => x.Available ? "Yes" : "No",
                alignment: ColumnAlignment.Center, width: 10)
            .AddItems(s_products)
        ...
        PromptPlus.Controls.TableMultiSelect<Product>("Filter products - Contains / Answer")
            .AddColumn("Name",     x => x.Name,     isFilterable: true)
        ...
        PromptPlus.Controls.TableMultiSelect<Product>("Filter products - StartsWith / ColumnFilters")
            .AddColumn("Name",     x => x.Name,     isFilterable: true)
            .AddColumn("Category", x => x.Category, isFilterable: true)
            .AddColumn("Origin",   x => x.Origin,   isFilterable: true)
            .AddItems(s_products)
        ...
        PromptPlus.Controls.TableMultiSelect<Product>("Filter products - Contains / ColumnFilters")
            .AddColumn("Name",     x => x.Name,     isFilterable: true)
            .AddColumn("Category", x => x.Category, isFilterable: true)
            .AddColumn("Origin",   x => x.Origin,   isFilterable: true)
        ...
        var r10 = PromptPlus.Controls.TableMultiSelect<Product>("Select products (async description + answer)")
            .AddColumn("Name",  x => x.Name)
            .AddColumn("Price", x => x.Price, v => $"${v:N2}", alignment: ColumnAlignment.Right)
            .AddColumn("Stock", x => x.Stock, alignment: ColumnAlignment.Right, width: 7)
            .AddItems(s_products)
        ...
        var r11 = PromptPlus.Controls.TableMultiSelect<Product>("Select products (loaded via interaction)")
            .AddColumn("Id",    x => x.Id,    width: 4,  alignment: ColumnAlignment.Right)
            .AddColumn("Name",  x => x.Name)
            .AddColumn("Price", x => x.Price, v => $"${v:N2}", alignment: ColumnAlignment.Right)
        ...
        var r12 = PromptPlus.Controls.TableMultiSelect<Product>(
            ...
            .EnableHistory("tablemultiselect-product-history")
            .UseDefaultHistory()
            .TextSelector(item => item.Name)
            .Run();
        PrintResult(r12);
        ...
        var r13 = PromptPlus.Controls.TableMultiSelect<Product>(
        ...
        // --------------------------------------------------------------------
        // 16 - Custom Styles (TableMultiSelectStyles)
        ...
        var r16 = PromptPlus.Controls.TableMultiSelect<Product>("Select products (custom styles)")
            .AddColumn("Name",     x => x.Name)
            .AddColumn("Category", x => x.Category)
            .AddColumn("Price",    x => x.Price, v => $"${v:N2}", alignment: ColumnAlignment.Right)
    ...
    {
        PromptPlus.Controls.TableMultiSelect<Product>($"LayoutMode.{mode}")
            .LayoutMode(mode)
            .AddColumn("Name",     x => x.Name)
            .AddColumn("Category", x => x.Category)
            .AddColumn("Price",    x => x.Price, v => $"${v:N2}", alignment: ColumnAlignment.Right)
    ...
    {
        PromptPlus.Controls.TableMultiSelect<Product>($"HideElements: {label}")
            .HideElements(hide)
            .AddColumn("Name",     x => x.Name)
            .AddColumn("Category", x => x.Category)
            .AddColumn("Price",    x => x.Price, v => $"${v:N2}", alignment: ColumnAlignment.Right)
    ...
    private static ITableMultiSelectControl<Employee> BuildEmployeeTable(
        string prompt, HorizontalScrollMode scroll)
    {
        return PromptPlus.Controls.TableMultiSelect<Employee>(prompt, "12 columns - use \u2190 \u2192 to scroll columns")
