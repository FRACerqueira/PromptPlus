...
namespace ConsoleNodeTreeMultiSelectSamples
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            PromptPlus.Widgets.DoubleDash("Sample Node Tree MultiSelect (All Employee loaded checked when expanded)", extraLines: 1);
            ...
            var result = PromptPlus.Controls.NodeTreeMultiSelect<MyOrg>("Node : ","My description")
                ...
                .Interaction(MyOrg.LoadTribe(), (item,ctrl) =>
                {
                    ...
                    foreach (var ges in gests)
                    {
                        ...
                        {
                            ctrl.AddChildNode(ges, fun, true);
                        }
                    }
                })
                .Run();
            ...
            PromptPlus.Widgets.DoubleDash("Sample Node Tree MultiSelect with Predicate Disabled", extraLines: 1);

            result = PromptPlus.Controls.NodeTreeMultiSelect<MyOrg>("Select Employee : ", "My description")
                .TextSelector((x) => x.Name)
            ...
            PromptPlus.Widgets.DoubleDash("Sample Node Tree MultiSelect with Predicate seleted", extraLines: 1);

            result = PromptPlus.Controls.NodeTreeMultiSelect<MyOrg>("Select Manager : ", "My description")
                .TextSelector((x) => x.Name)
            ...
            PromptPlus.Widgets.DoubleDash("Sample Node Tree MultiSelect with Custom colors", extraLines: 1);

            result = PromptPlus.Controls.NodeTreeMultiSelect<MyOrg>("Node : ", "My description")
                .TextSelector((x) => x.Name)
