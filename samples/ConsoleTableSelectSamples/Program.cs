...
namespace ConsoleTableSelectSamples
{
    internal class Program
    {
        ...
        static void Main()
        {
            ...
            PromptPlus.Widgets.DoubleDash($"TableSelect - basic", DashOptions.DoubleBorder, style: Color.Yellow, extraLines: 1);
            var tbl = PromptPlus.Controls.TableSelect<MyTable>("Your Prompt : ", "Description Table")
            ...
            PromptPlus.Widgets.DoubleDash($"TableSelect - with custom answer", DashOptions.DoubleBorder, style: Color.Yellow, extraLines: 1);
            ...
            PromptPlus.Widgets.DoubleDash("TableSelect - with history", extraLines: 1);
            ...
            PromptPlus.Widgets.DoubleDash($"TableSelect - with custom colors", DashOptions.DoubleBorder, style: Color.Yellow, extraLines: 1);
            ...
            PromptPlus.Widgets.DoubleDash($"TableSelect - FilterByColumns(Contains) enabled('F4')", DashOptions.DoubleBorder, style: Color.Yellow, extraLines: 1);
