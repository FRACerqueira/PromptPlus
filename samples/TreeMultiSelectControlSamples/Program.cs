...
namespace TreeMultiSelectControlSamples
{
    /// <summary>
    ...
    internal static class Program
    {
        private static void Main()
        {
            ...
            var t1 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t2 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t3 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t4 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t5 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t6 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t7 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t8 = PromptPlus.Controls.TreeMultiSelect<Node>(
                    "API and Mobile are pre-checked",
                    "TreeMultiSelect auto-expands to show each pre-checked node")
                .Root(root)
                .TextSelector(n => n.Name)
                .DefaultMatchBy((a, b) => a.Id == b.Id)
                .Default([api, mobile]);
            ...
            var t9 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t10 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t11 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            try
            {
                var t11First = PromptPlus.Controls.TreeMultiSelect<Node>("Check some nodes (will be remembered)")
                    .Root(root)
                    .TextSelector(n => n.Name)
                    .DefaultMatchBy((a, b) => a.Id == b.Id)
                ...
                var t11Second = PromptPlus.Controls.TreeMultiSelect<Node>("Runs again (checked state from history)")
                    .Root(root)
                    .TextSelector(n => n.Name)
                    .DefaultMatchBy((a, b) => a.Id == b.Id)
                    .EnableHistory(historyKey);
            ...
            var t12 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t13 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t14 = PromptPlus.Controls.TreeMultiSelect<Node>("Async description (simulated I/O)")
                .Root(root)
                .TextSelector(n => n.Name)
                .DefaultMatchBy((a, b) => a.Id == b.Id)
            ...
            var t15 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t16 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            int nextId = 1000;
            var t17 = PromptPlus.Controls.TreeMultiSelect<Node>(
                    "TreeMultiSelect populated by Interaction<T1>",
            ...
            var t18 = PromptPlus.Controls.TreeMultiSelect<Node>("TreeMultiSelect populated by InteractionAsync<T1>")
            ...
            var t19 = PromptPlus.Controls.TreeMultiSelect<Node>("Fully customized rendering")
                .Root(root)
                .TextSelector(n => n.Name)
                .ExtraInfo(n => n.Info)
                .DefaultMatchBy((a, b) => a.Id == b.Id)
            ...
            var t20 = PromptPlus.Controls.TreeMultiSelect<Node>(
                    "Built by Interaction<T1>; Dept-10→Team-10-05 and Dept-20→Team-20-12 pre-checked",
                    "TreeMultiSelect auto-expands to each pre-checked node")
            ...
            var t21 = PromptPlus.Controls.TreeMultiSelect<Node>("Notice the order of the top-level nodes")
                .Root(root)
                .TextSelector(n => n.Name)
                .DefaultMatchBy((a, b) => a.Id == b.Id);
            ...
            var t22 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            // (unlike TreeSelect/Select) and survives a later F2 mass-uncheck untouched, matching
            // IMultiSelectControl's behavior for disabled defaults.
            var t22b = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            // IMultiSelectControl<T>.AddItem(ischecked:)/ITableMultiSelectControl<T>.AddItem(ischecked:).
            // AddLast/AddFirst/AddAfter/AddBefore all return ITreeMultiSelectNode<T> (not the plain
            // ITreeNode<T> that TreeSelectControl uses), so chaining deeper into the tree keeps access
            // to check, not just the top-level calls made directly off the control.
            var t23 = PromptPlus.Controls.TreeMultiSelect<Node>(
            ...
            var t23b = PromptPlus.Controls.TreeMultiSelect<Node>(
        ...
        private static void PopulateGrouped(ITreeMultiSelectControl<Node> ctrl, int groupCount, int itemsPerGroup, int startId)
        {
            int id = startId;
        ...
        private static void BuildFullTree(
            ITreeMultiSelectControl<Node> t,
