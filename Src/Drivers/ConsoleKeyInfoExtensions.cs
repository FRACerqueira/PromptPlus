...
namespace PPlus
{
    public static partial class PromptPlus
    {
        ...
        public static ConsoleKeyInfo ToCase(this ConsoleKeyInfo keyinfo, CaseOptions value)
        {
            return value switch
            {
                CaseOptions.Uppercase => new ConsoleKeyInfo(char.ToUpperInvariant(keyinfo.KeyChar), keyinfo.Key, keyinfo.Modifiers.HasFlag(ConsoleModifiers.Shift), keyinfo.Modifiers.HasFlag(ConsoleModifiers.Alt), keyinfo.Modifiers.HasFlag(ConsoleModifiers.Control)),
                CaseOptions.Lowercase => new ConsoleKeyInfo(char.ToLowerInvariant(keyinfo.KeyChar), keyinfo.Key, keyinfo.Modifiers.HasFlag(ConsoleModifiers.Shift), keyinfo.Modifiers.HasFlag(ConsoleModifiers.Alt), keyinfo.Modifiers.HasFlag(ConsoleModifiers.Control)),
                _ => keyinfo,
            };
        }
