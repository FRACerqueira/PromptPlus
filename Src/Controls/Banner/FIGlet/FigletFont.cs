...
namespace PPlus.FIGlet
{
    ...
    internal class FIGletFont
    {
                    ...
                    if (defaultFont == null)
                    {
                        ...
                        try
                        {
                            stream = typeof(FIGletFont).GetTypeInfo().
                                  Assembly.GetManifestResourceStream("PPlus.Controls.Banner.FIGlet.Fonts.standard.flf");
        ...
        public FIGletFont(Stream fontStream)
        {
            ...
            {
                throw new PromptPlusException($"FIGletFont {nameof(fontStream)} missing signature");
            }
        ...
        public string GetCharacter(char sourceChar, int line)
        {
            ...
            {
                throw new PromptPlusException($"FIGletFont Range invalid at line {line}");
            }
