...
namespace PPlus.Controls
{
    ...
    /// </summary>
    public interface IControlTableSelect<T> : IPromptControls<ResultTableSelect<T>> where T : class
    {
        /// <summary>
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> OverwriteDefaultFrom(string value, TimeSpan? timeout = null);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> AddItem(T value, bool disable = false);
        ...
        /// <param name="disable">true item disabled, otherwise no</param>
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> AddItems(IEnumerable<T> values, bool disable = false);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> EqualItems(Func<T, T, bool> comparer);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> FilterByColumns(FilterMode filter,params ushort[] indexColumn);
        ...
        /// </param>
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> ChangeDescription(Func<T, int, int, string> value);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> Title(string value, Alignment alignment = Alignment.Center, TableTitleMode titleMode = TableTitleMode.InLine);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> AddColumn(Expression < Func<T, object>> field, ushort width, Func<object, string> format = null,Alignment alignment = Alignment.Left, string? title = null, Alignment titlealignment = Alignment.Center,bool titlereplaceswidth = true, bool textcrop = false, ushort? maxslidinglines = null);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> AutoFill(params ushort?[] minmaxwidth);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> SeparatorRows(bool value = true);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> HideHeaders(bool value = true);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> HideSelectorRow(bool value = true);
        ...
        /// </param>
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> AutoFit(params ushort[] indexColumn);
        ...
        /// </param>
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> Templates(Func<T, int, int, string> selectedTemplate = null, Func<T, int, int, string> finishTemplate = null);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> ColumnsNavigation(bool value = true);
        ...
        /// <returns><see cref="IControlTableSelect{T}"/></returns>
        IControlTableSelect<T> AutoSelect(bool value = true);
